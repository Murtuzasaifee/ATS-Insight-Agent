...
from src.ats_insight_agent.state.ats_state import ATSState, CustomEncoder
import os
...
def save_state_to_redis(task_id: str, state: ATSState):
...
def get_state_from_redis(task_id: str) -> Optional[ATSState]:
